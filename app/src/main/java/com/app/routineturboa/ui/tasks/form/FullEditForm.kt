...
fun FullEditForm(
    ...
    var startTimeString by remember {mutableStateOf(timeToUiString(startTime))}
    var endTimeString by remember {mutableStateOf(timeToUiString(endTime))}
    var reminderString by remember {mutableStateOf(timeToUiString(reminder))}
        ...
        Surface(
            ...
            Column(
                ...
                SelectTaskTypeDropdown(
                    ...
                    selectedLinkedMainTask = linkedMainTaskIdIfHelper,
                    onLinkedMainTaskSelected = { taskId -> linkedMainTaskIdIfHelper = taskId },
                        ...
                        onClick = {
                            ...
                            coroutineScope.launch {
                                ...
                                val updatedTaskFormData = TaskFormData(
                                    ...
                                    duration = duration,
                                    reminder = reminder,
                                    linkedMainIfHelper = linkedMainTaskIdIfHelper,
